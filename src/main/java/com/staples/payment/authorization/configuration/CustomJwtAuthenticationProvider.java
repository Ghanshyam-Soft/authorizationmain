 ...
 */
@Configuration
public class CustomJwtAuthenticationProvider implements AuthenticationProvider // This is identical to the normal JwtAuthenticationProvider except for the try catch noted as added code below
{
	...
	public Authentication authenticate(Authentication authentication) throws AuthenticationException
	{
		...
		catch(AuthenticationException ae) // This is the added code. We added it to get visibility into failed authentication attempts
		{
			logger.error("Authentication Exception happened due to Oauth2.0 auth token failure", ae);
			throw ae;
		}
